document.addEventListener('DOMContentLoaded', function () {
  ...
  function populateAthleteSelectOptions() {
    ...
    fetch('http://ec2-44-201-200-110.compute-1.amazonaws.com/athletes', {
      method: 'GET',
      headers: {
  ...
  form.addEventListener('submit', function (event) {
    ...
    function checkAthleteExists(id, token) {
      return fetch(`http://ec2-44-201-200-110.compute-1.amazonaws.com/athlete/${id}`, { // Alterado para verificar se o atleta existe usando seu ID
        method: 'GET',
        headers: {
          'Authorization': `Bearer ${token}`
        }
